...
//        Declararea si initializarea obiectelor folosind toate dipurile de constructori
        ...
        System.out.println("Masina " + mercedesBenzSeriaE.make + " de model " + mercedesBenzSeriaE.model +
                " de culoare " + mercedesBenzSeriaE.color + " are numarul de imatriculare " + mercedesBenzSeriaE.plateNumber
